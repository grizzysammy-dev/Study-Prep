...
```
Run: `python3 script.py arg`. Isolate deps with a **venv** (see [chroot and Python venv](../03%20-%20Linux%20Skills/chroot%20and%20Python%20venv.md)).
...
```
> [!warning] On modern distros a bare `pip install requests` fails with **"externally-managed-environment" (PEP 668)** to protect the system Python. Fixes, best first: use a **venv** (above), or `pipx` for apps, or `--break-system-packages` only if you truly mean it. Full detail in [chroot and Python venv](../03%20-%20Linux%20Skills/chroot%20and%20Python%20venv.md) and [Package Management](../03%20-%20Linux%20Skills/Package%20Management.md).
...
- [chroot and Python venv](../03%20-%20Linux%20Skills/chroot%20and%20Python%20venv.md)
- [RegEx](RegEx.md)
- [Package Management](../03%20-%20Linux%20Skills/Package%20Management.md)
