...
## Concept
**Mental model:** picture an intrusion as a line of dominoes that has to topple *in order* — case the target, build the payload, deliver it, pop the box, dig in, call home, then act. The attacker needs every domino to fall; you win by pulling out any single one. That asymmetry is the whole idea, and it's the defender's edge: you don't have to catch everything, just one thing, as early as you can.
