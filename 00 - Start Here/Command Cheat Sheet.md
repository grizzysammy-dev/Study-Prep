...
Pure commands. Concepts/gotchas are in [Exam-Day Quick Reference](Exam-Day%20Quick%20Reference.md); each tool has its own full note.
...
## Netcat / telnet — [Netcat](../02%20-%20Recon%20and%20Network%20Tools/Netcat.md)
```bash
...
## Tcpdump — [Tcpdump](../02%20-%20Recon%20and%20Network%20Tools/Tcpdump.md)
```bash
...
## Connections / interfaces — [Interfaces IPs and Routing](../03%20-%20Linux%20Skills/Interfaces%20IPs%20and%20Routing.md) · [Processes and systemd](../03%20-%20Linux%20Skills/Processes%20and%20systemd.md)
```bash
...
## SSH / SCP — [SSH - Tunneling and Jump Hosts](../02%20-%20Recon%20and%20Network%20Tools/SSH%20-%20Tunneling%20and%20Jump%20Hosts.md) · [SCP](../02%20-%20Recon%20and%20Network%20Tools/SCP.md)
```bash
...
## Firewall (iptables) — [iptables](../03%20-%20Linux%20Skills/iptables.md)
```bash
...
## Processes / services — [Processes and systemd](../03%20-%20Linux%20Skills/Processes%20and%20systemd.md)
```bash
...
## Packages — [Package Management](../03%20-%20Linux%20Skills/Package%20Management.md)
```bash
...
## Files / search / perms — [Files Search and Permissions](../03%20-%20Linux%20Skills/Files%20Search%20and%20Permissions.md)
```bash
...
## Disks / mounts — [Disks Mounts and fstab](../03%20-%20Linux%20Skills/Disks%20Mounts%20and%20fstab.md)
```bash
...
## cron — [cron](../03%20-%20Linux%20Skills/cron.md)
```bash
crontab -e ; crontab -l
...
## Windows CLI / PowerShell — [Windows CLI and net Commands](../04%20-%20Windows%20Skills/Windows%20CLI%20and%20net%20Commands.md) · [PowerShell Essentials](../04%20-%20Windows%20Skills/PowerShell%20Essentials.md)
```bat
...
## Metasploit — [Metasploit Workflow](../05%20-%20Metasploit%20and%20Exploitation/Metasploit%20Workflow.md)
```
