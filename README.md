...
These are my study notes for the **Cyber Candidate JQR**. I organized everything by tool and topic, the same way I built the repo, so during prep I can jump straight to whatever I'm working on. I keep it in [Obsidian](https://obsidian.md) and sync it here so it's readable during prep and open-book work, when the only thing I can pull up is this public repo.

> **Start here:** the **[Command Cheat Sheet](Study%20Aids/Command%20Cheat%20Sheet.md)** and the **[Exam-Day Quick Reference](Study%20Aids/Exam-Day%20Quick%20Reference.md)**. To track what I can actually *do*, not just what I've read, there's the **[JQR Progress Checklist](Study%20Aids/JQR%20Progress%20Checklist.md)**.

**How I wrote these:** every note opens with plain English on why the thing exists and how it works before I get anywhere near a command, and I say what each command actually does as I go. When I've run something myself, I paste the real output right under a line saying so. If something's only correct per the current docs and I haven't run it on my own box yet, I flag that instead of pretending.
...
*The runnable scripts live in [`/scripts`](scripts). Where a note has real output pasted in, that means I actually ran it on a current Linux box. Each note lists its own sources at the bottom, and they're all rolled up in [References and Sources](Study%20Aids/References%20and%20Sources.md).*
